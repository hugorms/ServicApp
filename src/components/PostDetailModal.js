...
import { X, Star, MapPin, Phone, Mail, DollarSign, Clock, Calendar, User, ArrowRight, ChevronLeft, ChevronRight } from 'lucide-react';
...
const PostDetailModal = ({ isOpen, onClose, post, onApply, hasApplied = false }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-3">
      <div className="bg-white rounded-2xl w-[340px] max-h-[85vh] overflow-y-auto mx-auto">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-yellow-400 to-yellow-500 p-3 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <h2 className="text-base font-bold text-slate-800">Detalles del Trabajo</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-3 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <span className="text-2xl">{getSpecialtyIcon(post.specialty)}</span>
            ...
            {post.description && (
              <div className="bg-gray-50 rounded-xl p-2">
                <h4 className="font-bold text-slate-700 text-xs mb-1">Descripción</h4>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {post.estimated_hours && (
                <div className="bg-blue-50 rounded-xl p-2 text-center">
                  ...
                  <p className="text-sm font-bold text-slate-800">{post.estimated_hours}h</p>
            ...
            {/* Ubicación */}
            <div className="bg-gray-50 rounded-xl p-2">
              <h4 className="font-bold text-slate-700 text-xs mb-1">Ubicación</h4>
              <div className="flex items-start text-slate-600">
                <MapPin className="w-3 h-3 mr-1 text-yellow-500 mt-0.5 flex-shrink-0" />
                <div className="text-xs">
                  ...
                  {post.specific_address && (
                    <p className="text-xs text-slate-500 mt-0.5">{post.specific_address}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-1">
              <button
                ...
                className="flex-1 bg-gray-200 text-slate-700 py-2 rounded-xl font-bold text-xs hover:bg-gray-300 transition-colors"
              ...
              {hasApplied ? (
                <div className="flex-1">
                  <div className="bg-blue-100 text-blue-700 py-2 rounded-xl font-bold text-xs flex items-center justify-center mb-1">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white py-2 rounded-xl font-bold text-xs hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg flex items-center justify-center"
                >
